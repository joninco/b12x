...
128, including the 16-token direct-micro boundary. Reduction fills the bounded
1--128 serving domain from the nearest valid measured anchor. It never extends
micro beyond 16 tokens or Triton route
